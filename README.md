...
but **controlled entirely from Python**. The C engine provides the "hardware" primitives; Python acts as the control unit,  
instruction decoder, and microcode ROM.  
